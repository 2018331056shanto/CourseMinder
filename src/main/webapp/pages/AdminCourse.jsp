...
<div class="w-full max-w-2xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between mb-4">
        <h5 class="text-xl font-bold leading-none text-gray-700 dark:text-white">Courses</h5>
       <span class="text-xl font-bold leading-none text-gray-700 dark:text-white">Enrolled</span>
   </div>
   <div class="flow-root">
            ...
            <li class="py-3 sm:py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                       <a href="/Servlet-Project/in/admin/course/${entry.key.getId()}">
...
<div id="input-container1" class="w-full justify-center flex">
  <div class="w-3/4 flex justify-between p-4 mt-8 bg-white border border-gray-200 rounded-lg shadow sm:p-2 dark:bg-gray-800 dark:border-gray-700">
    <span class="px-4 py-2 font-serif font-bold text-xl ">Add New Course</span> 
    <button class="px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none" onclick="showInput()">Add</button>
